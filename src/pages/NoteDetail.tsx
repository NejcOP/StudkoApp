...
const NoteDetail = () => {
  ...
  const NoteDetail = () => {
    ...
    useEffect(() => { fetchNote(); checkPurchaseStatus(); }, [fetchNote, checkPurchaseStatus]);
    ...
    return (
      <div className="min-h-screen bg-background">
        <Navigation />
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 py-8 max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow p-6">
              <h2 className="font-bold mb-4">AI orodja</h2>
